...
class RepairOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair_order" do
    assert_difference('RepairOrder.count') do
      post repair_orders_url, params: { repair_order: { ajax: @repair_order.ajax, car_id: @repair_order.car_id, claim_number: @repair_order.claim_number, description: @repair_order.description, operation_number: @repair_order.operation_number, order_number: @repair_order.order_number } }
    end
  ...
  test "should update repair_order" do
    patch repair_order_url(@repair_order), params: { repair_order: { ajax: @repair_order.ajax, car_id: @repair_order.car_id, claim_number: @repair_order.claim_number, description: @repair_order.description, operation_number: @repair_order.operation_number, order_number: @repair_order.order_number } }
