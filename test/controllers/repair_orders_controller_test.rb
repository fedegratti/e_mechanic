...
class RepairOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair_order" do
    assert_difference('RepairOrder.count') do
      post repair_orders_url, params: { repair_order: { ajax: @repair_order.ajax, description: @repair_order.description, order_number: @repair_order.order_number } }
    end
  ...
  test "should update repair_order" do
    patch repair_order_url(@repair_order), params: { repair_order: { ajax: @repair_order.ajax, description: @repair_order.description, order_number: @repair_order.order_number } }
